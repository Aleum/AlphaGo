...
do
	...
	gogui-twogtp -black 'python /home/sclab/dclee/simplego/play_gtp.py' -white 'python /home/sclab/dclee/minigo/play_gtp.py' -size 9 -verbose -xml -auto -sgffile ttt -force -sgffile $filename -games 1 
        #sleep 600
done
sleep 3 
done
