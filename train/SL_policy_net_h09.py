...
SAVE_FOLDER_NAME = "20160604_sl_h09"
...
class save_callback(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        self.model.save_weights(SAVE_FOLDER_NAME+"/policy_net_weights_h09_"+str(epoch)+".h5")
        if epoch  == 50:
...
if __name__ == "__main__":
    ...
    open(SAVE_FOLDER_NAME+"/policy_net_model_h09.json", "w").write(json_string)
    stop = save_callback()
