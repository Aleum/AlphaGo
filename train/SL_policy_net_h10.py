...
SAVE_MODEL_FOLDER = "20160608/h10"
...
class save_callback(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        self.model.save_weights(SAVE_MODEL_FOLDER+"/policy_net_weights_h10_"+str(epoch)+".h5")
        if epoch  == 50:
...
if __name__ == "__main__":
    ...
    open(SAVE_MODEL_FOLDER+"/policy_net_model_h10.json", "w").write(json_string)
    stop = save_callback()
