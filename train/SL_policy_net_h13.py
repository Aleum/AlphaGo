...
SAVE_FOLDER_NAME = "20160606_sl_h13+other"

POSTFIX = "_x.csv"
PRO_TRAIN_FOLDER = "other+pro_features_100/"
...
class save_callback(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        self.model.save_weights(SAVE_FOLDER_NAME+"/policy_net_weights_h13_"+str(epoch)+".h5")
        if epoch  == 50:
...
if __name__ == "__main__":
    ...
    open(SAVE_FOLDER_NAME+"/policy_net_model_h13"+str(epoch)+".json", "w").write(json_string)
    stop = save_callback()
